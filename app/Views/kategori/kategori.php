                                    ...
                                    foreach ($kategori as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="col-2 text-center">
                                                <a href="<?= base_url(); ?>edit-kategori/<?= $value->id_kategori; ?>" class="btn btn-warning btn-sm mr-1"><i class="fas fa-pencil-alt"></i></a>
                                                <form action="<?= base_url(); ?>delete-kategori/<?= $value->id_kategori; ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
