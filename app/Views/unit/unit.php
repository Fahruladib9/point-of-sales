                                    ...
                                    foreach ($unit as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="col-2 text-center">
                                                <a href="<?= base_url(); ?>edit-unit/<?= $value->id_unit; ?>" class="btn btn-warning btn-sm mr-1"><i class="fas fa-pencil-alt"></i></a>
                                                <form action="<?= base_url(); ?>delete-unit/<?= $value->id_unit; ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
