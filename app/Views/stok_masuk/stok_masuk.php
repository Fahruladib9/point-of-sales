    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url(); ?>stok-masuk/tambah" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control searchselect" name="suplier" id="suplier" required>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($stok_masuk as $key => $value) : ?>
                                        <tr>
                                            <td><?= $key + 1; ?></td>
                                            ...
                                            <td class="text-center">
                                                <form action="<?= base_url(); ?>delete-stok-masuk/<?= $value->id_stokMasuk; ?>" method="post" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
